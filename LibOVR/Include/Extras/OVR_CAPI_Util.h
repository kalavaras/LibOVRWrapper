...
#ifndef OVR_CAPI_Util_1_3_h
#define OVR_CAPI_Util_1_3_h
...
///
typedef enum ovrProjectionModifier1_3_
{
    ...
    ovrProjection1_3_None = 0x00,

    /// Enable if using left-handed transformations in your application.
    ovrProjection1_3_LeftHanded = 0x01,
    ...
    ovrProjection1_3_FarLessThanNear = 0x02,

    /// When this flag is used, the zfar value pushed into ovrMatrix4f_Projection() will be ignored
    /// NOTE: Enable only if ovrProjection_FarLessThanNear is also enabled where the far clipping plane will be pushed to infinity.
    ovrProjection1_3_FarClipAtInfinity = 0x04,
    ...
    ovrProjection1_3_ClipRangeOpenGL = 0x08,
} ovrProjectionModifier1_3;
...
/// \see ovr_Detect
///
typedef struct OVR_ALIGNAS(8) ovrDetectResult1_3_
{
...
OVR_STATIC_ASSERT(sizeof(ovrDetectResult1_3) == 8, "ovrDetectResult size mismatch");
...
///
OVR_PUBLIC_FUNCTION(ovrMatrix4f) ovrMatrix4f_Projection1_3(ovrFovPort1_3 fov, float znear, float zfar, unsigned int projectionModFlags);
...
///
OVR_PUBLIC_FUNCTION(ovrTimewarpProjectionDesc1_3) ovrTimewarpProjectionDesc_FromProjection1_3(ovrMatrix4f projection, unsigned int projectionModFlags);
...
/// \return Returns the calculated projection matrix.
///
OVR_PUBLIC_FUNCTION(ovrMatrix4f) ovrMatrix4f_OrthoSubProjection1_3(ovrMatrix4f projection, ovrVector2f orthoScale,
