...
#ifndef OVR_Version_1_3_h
#define OVR_Version_1_3_h
...
#define OVR_PRODUCT_VERSION_1_3 1  // Product version doesn't participate in semantic versioning.
#define OVR_MAJOR_VERSION_1_3   1  // If you change these values then you need to also make sure to change LibOVR/Projects/Windows/LibOVR.props in parallel.
#define OVR_MINOR_VERSION_1_3   3  // 
#define OVR_PATCH_VERSION_1_3   0
#define OVR_BUILD_NUMBER_1_3    0
